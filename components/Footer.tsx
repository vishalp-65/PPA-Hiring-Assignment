...
const Footer = (props: Props) => {
    return (
        <div className="flex items-start justify-evenly gap-5 bg-[#263238] px-16 py-10 text-white">
            <div className="flex flex-col justify-between items-start w-[40%] gap-10">
            ...
            <div className="flex items-start justify-between gap-20">
                ...
                <div className="flex flex-col items-start justify-between gap-5">
                    <p className="font-semibold text-md">Stay up to date</p>
                    <input
